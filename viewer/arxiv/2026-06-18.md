...
- **Summary:** The paper constructs Hilbert spaces for closed-universe minisuperspace quantum cosmology in the extreme slow-roll limit, showing that fixing the scalar potential yields a one-dimensional physical space consistent with Vilenkin's tunneling wavefunction, while allowing it to vary produces an infinite-dimensional space with boundary conditions that nearly single out the Hartle-Hawking state.
...
- **Summary:** The paper analyzes the shadow, photon sphere, and strong-field lensing properties of dyon-like dilatonic black holes, deriving constraints on charge and dilatonic coupling parameters from M87* and SgrA* observational data and computing the leading Bozza coefficient for the deflection angle.
...
- **Summary:** The paper predicts that uniformly accelerated atoms exhibit spectral blind spots in stimulated transitions—frequencies where both ordinary absorption and acceleration-induced excitation vanish simultaneously—providing a distinctive signature of the Unruh effect manifesting as an absence rather than enhancement of response.
- **Relevance:** physics
- **Tags:** physics
...
- **Summary:** The paper classifies four-dimensional gravitational theories with quasi-topological integrability for metrics with Taub-NUT, near-horizon extreme Kerr, and Eguchi-Hanson symmetries, constructing regular static black hole solutions from infinite towers of high-energy corrections with first-order field equations.
...
- **Summary:** The paper develops a systematic framework for black hole thermodynamic representations and response functions applied to quasi-local Schwarzschild black holes in spherical cavities, finding that stability is representation-dependent with thermal stability at fixed volume but mechanical instability under isothermal compression.
...
- **Summary:** The paper derives the Lehmann-Symanzik-Zimmermann reduction formalism for massive spin-2 particles and extends it to Friedmann-Lemaître-Robertson-Walker spacetimes, proving that the Goldstone boson equivalence theorem holds on cosmological backgrounds and analyzing its range of validity.
- **Relevance:** physics
- **Tags:** physics
...
- **Summary:** The paper derives the dimensional reduction of 11D supergravity to 10D Type IIA via cyclification, showing that full on-shell 10D IIA supergravity is equivalently characterized by $L_\infty$-algebra Bianchi identities on NS/RR super-flux densities over supertorsion-free superspace.
- **Relevance:** physics
- **Tags:** physics
...
- **Summary:** The paper obtains a general exact solution for the motion of spinning test particles in global monopole spacetime using the Mathisson-Papapetrou-Dixon equations, establishes complete integrability of the system, and compares the resulting non-geodesic trajectories with spinless particle motion.
- **Relevance:** physics
- **Tags:** physics
...
- **Summary:** The paper reformulates the variational principle for relativistic perfect fluids in a manifestly covariant differential-forms framework, extends it to null flows where the equations force $\rho+P=0$ yielding a vacuum-energy-plus-null-dust decomposition, and shows the construction generalizes beyond metric theories of gravity.
- **Relevance:** physics
- **Tags:** physics
...
- **Summary:** The paper presents an endpoint-safe Fourier method for multi-field vacuum tunnelling path optimization implemented with automatic differentiation, achieving sub-percent agreement with established solvers while reducing runtime by up to $90\%$ when used as a preconditioner for high-dimensional bounce calculations.
- **Relevance:** physics
- **Tags:** physics
...
- **Summary:** The paper demonstrates that pre-geometric gravity, formulated as a Yang-Mills theory with a Higgs-like field undergoing spontaneous symmetry breaking, can generate an effective metric and classical gravitational dynamics consistent with all three formulations of the Geometric Trinity of Gravity.
- **Relevance:** physics
- **Tags:** physics
...
- **Summary:** The paper extends the Peres-Horodecki separability criterion to noncommutative phase-space deformations, shows that bipartite Gaussian states are almost always entangled under position-position and momentum-momentum noncommutativity, and proposes a gedankenexperiment to detect such entanglement as a signature of quantum gravity.
...
- **Summary:** The paper reviews one-loop graviton self-energy corrections during de Sitter inflation, showing that conformally coupled matter produces only logarithmic enhancements while minimally coupled scalars induce much stronger corrections to gravitational wave mode functions, interpretable as a shift in the inflationary Hubble parameter.
- **Relevance:** physics
- **Tags:** physics
...
- **Summary:** The paper demonstrates the emergence of de Sitter spacetime from a non-unitary continuous MERA applied to a non-Hermitian critical fermion chain, showing that geodesics act as extremal Ryu-Takayanagi surfaces undergoing a timelike-to-null transition and that the resulting tensor network reproduces logarithmic entanglement entropy scaling with zero-cost links along the horizon.
...
- **Summary:** The paper treats spacetime singularities as free boundaries in the gravitational action principle, deriving on-shell boundary conditions that exclude Kasner and BKL singularities while admitting conformally regular spacetimes and yielding reflecting boundary conditions for standard big bang cosmological perturbations.
- **Relevance:** physics
- **Tags:** physics
